...
public class RegionServiceImpl extends ServiceImpl<RegionMapper, Region> implements IRegionService {
    ...
    public void active(Long id) {
        ...
        Integer i = serveService.queryServeCountByRegionIdAndStatus(id, FoundationStatusEnum.ENABLE.getStatus());
        if (i > 0) {
            throw new ForbiddenOperationException("区域下有上架的服务无法启用");
        }
    ...
    public void deactivate(Long id) {
        ...
        Integer count = serveService.queryServeCountByRegionIdAndStatus(id, FoundationStatusEnum.ENABLE.getStatus());
        if (count > 0) {
